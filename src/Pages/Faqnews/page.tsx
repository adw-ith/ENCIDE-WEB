    ...
    return <section className=' grid md:grid-cols-2 grid-cols-1  bg-faqbg'>
        <div className=' col-span-1 p-4 bg-slate-800'>
            <div className=' p-8 w-full'>
                ...
                <div className=" relative backdrop-blur-2xl text-white px-7 py-5 bg-slate-800 mt-5 rounded-xl shadow-2xl border border-slate-700">
                    <div className=" absolute top-16 left-14 w-12 h-12 rounded-full bg-white blur-3xl"></div>
                    <div className=" py-4 px-2 pt-0 sm:pt-4 sm:px-11"><img className=" w-full h-auto mt-6" src="https://www.teslarati.com/wp-content/uploads/2024/01/Tesla-Cybertruck-2024-production-builds-to-be-sold-out-soon-.jpg" alt="" /></div>
                    <h1 className=" mt-3 text-2xl font-semibold">heading</h1>
                    <p className=" mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus sapiente doloribus officiis rerum quasi distinctio expedita facilis ipsam asperiores libero accusantium, sequi pariatur fugiat officia ratione nam consequuntur qui placeat?</p>
                </div>
            </div>
        </div>
